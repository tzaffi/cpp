...
// Based on: http://www.geeksforgeeks.org/external-sorting/
//
...
int main(int argc, char** argv) {
    ...
    char input_file[] = argv[1]; //"input.txt";
    char output_file[] = argv[2]; //"output.txt";

    cout << "input_file = " << input_file << endl;
    cout << "output_file = " << output_file << endl;

    /** Don't need the file generation code here
